# 2023/07/01|Домашнее задание по теме "Файлы в операционной системе".
# Цель задания:
#
...
import os
import time
# directory = "C:/Users/SES/PycharmProject/TestProject/HomeWork"
...
# directory = 'C:/Users/SES/PycharmProjects/TestProject/HomeWork' # Замените на путь к вашему каталогу
directory = os.getcwd()
