...
def max_(int_list):
    results = max(int_list)
    return results

def min_(int_list):
    results = min(int_list)
    return results

def len_(int_list):
    results = len(int_list)
    return results
...
def sorted_(int_list):
    results = sorted(int_list)
    return results
int_list = [6, 20, 15, 9]
def apply_all_func(int_list, *functions_):
    results_ = {}
    for i in functions_:
        results_.update({(str(i.__name__)): i(int_list) })
    return results_
